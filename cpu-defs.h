...
#define VMX_PIN_CTRL_EXT_INTERRUPT_EXITING  __BIT(0)
#define VMX_PIN_CTRL_NMI_EXITING            __BIT(3)
#define VMX_PIN_CTRL_VIRTUAL_NMIS           __BIT(5)
#define VMX_PIN_CTRL_ACTIVATE_PTIMER        __BIT(6)
#define VMX_PIN_CTRL_PROC_POSTED_INTERRUPTS __BIT(7)

/* Primary proc-based VM-execution controls */
#define VMX_PROC_CTRL_INTERRUPT_WINDOW_EXITING __BIT(2)
#define VMX_PROC_CTRL_USE_TSC_OFFSETTING       __BIT(3)
#define VMX_PROC_CTRL_HLT_EXITING              __BIT(7)
#define VMX_PROC_CTRL_INVLPG_EXITING           __BIT(9)
#define VMX_PROC_CTRL_MWAIT_EXITING            __BIT(10)
#define VMX_PROC_CTRL_RDPMC_EXITING            __BIT(11)
#define VMX_PROC_CTRL_RDTSC_EXITING            __BIT(12)
#define VMX_PROC_CTRL_CR3_LOAD_EXITING         __BIT(15)
#define VMX_PROC_CTRL_CR3_STORE_EXITING        __BIT(16)
#define VMX_PROC_CTRL_CR8_LOAD_EXITING         __BIT(19)
#define VMX_PROC_CTRL_CR8_STORE_EXITING        __BIT(20)
#define VMX_PROC_CTRL_USE_TPR_SHADOW           __BIT(21)
#define VMX_PROC_CTRL_NMI_WINDOW_EXITING       __BIT(22)
#define VMX_PROC_CTRL_MOV_DR_EXITING           __BIT(23)
#define VMX_PROC_CTRL_UNCONDITIONAL_IO_EXITING __BIT(24)
#define VMX_PROC_CTRL_USE_IO_BITMAPS           __BIT(25)
#define VMX_PROC_CTRL_MONITOR_TRAP_FLAG        __BIT(27)
#define VMX_PROC_CTRL_USE_MSR_BITMAPS          __BIT(28)
#define VMX_PROC_CTRL_MONITOR_EXITING          __BIT(29)
#define VMX_PROC_CTRL_PAUSE_EXITING            __BIT(30)
#define VMX_PROC_CTRL_ACTIVATE_SECONDARY_CTLS  __BIT(31)

/* Secondary proc-based VM-execution controls */
#define VMX_PROC_CTRL2_VIRTUALIZE_APIC         __BIT(0)
#define VMX_PROC_CTRL2_ENABLE_EPT              __BIT(1)
#define VMX_PROC_CTRL2_DESCR_TABLE_EXITING     __BIT(2)
#define VMX_PROC_CTRL2_ENABLE_RDTSCP           __BIT(3)
#define VMX_PROC_CTRL2_VIRTUALIZE_X2APIC       __BIT(4)
#define VMX_PROC_CTRL2_ENABLE_VPID             __BIT(5)
#define VMX_PROC_CTRL2_WBINVD_EXITING          __BIT(6)
#define VMX_PROC_CTRL2_URESTRICTED_GUEST       __BIT(7)
#define VMX_PROC_CTRL2_APIC_REGISTER_VIRT      __BIT(8)
#define VMX_PROC_CTRL2_VIRTUAL_INTERRUPTS      __BIT(9)
#define VMX_PROC_CTRL2_PAUSE_LOOP_EXITING      __BIT(10)
#define VMX_PROC_CTRL2_RDRAND_EXITING          __BIT(11)
#define VMX_PROC_CTRL2_ENABLE_INVPCID          __BIT(12)
#define VMX_PROC_CTRL2_ENABLE_VMFUNC           __BIT(13)
#define VMX_PROC_CTRL2_VMCS_SHADOWING          __BIT(14)
#define VMX_PROC_CTRL2_ENCLS_EXITING           __BIT(15)
#define VMX_PROC_CTRL2_RDSEED_EXITING          __BIT(16)
#define VMX_PROC_CTRL2_ENABLE_PML              __BIT(17)
#define VMX_PROC_CTRL2_EPT_VIOLATION_VE        __BIT(18)
#define VMX_PROC_CTRL2_CONCEAL_NONROOT_FROM_PT __BIT(19)
#define VMX_PROC_CTRL2_ENABLE_XSAVES_XRSTORS   __BIT(20)
#define VMX_PROC_CTRL2_MODE_BASED_EPT_CONTROL  __BIT(22)
#define VMX_PROC_CTRL2_USE_TSC_SCALING         __BIT(25)

/* VM exit controls */
#define VMCS_VMEXIT_CTRL_SAVE_DBG_CTLS              __BIT(2)
#define VMCS_VMEXIT_CTRL_HOST_ADDR_SPACE_SIZE       __BIT(9)
#define VMCS_VMEXIT_CTRL_LOAD_IA32_PERF_GLOBAL_CTRL __BIT(12)
#define VMCS_VMEXIT_CTRL_ACK_INTERRUPT_ON_EXIT      __BIT(15)
#define VMCS_VMEXIT_CTRL_SAVE_IA32_PAT              __BIT(18)
#define VMCS_VMEXIT_CTRL_LOAD_IA32_PAT              __BIT(19)
#define VMCS_VMEXIT_CTRL_SAVE_IA32_EFER             __BIT(20)
#define VMCS_VMEXIT_CTRL_LOAD_IA32_EFER             __BIT(21)
#define VMCS_VMEXIT_CTRL_SAVE_PTIMER_VAL            __BIT(22)
#define VMCS_VMEXIT_CTRL_CLEAR_IA32_BNDCFGS         __BIT(23)
#define VMCS_VMEXIT_CTRL_CONCEAL_VMEXIT_FROM_PT     __BIT(24)

/* VM entry controls */
#define VMCS_VMENTRY_CTRL_LOAD_DBG_CTLS                      __BIT(2)
#define VMCS_VMENTRY_CTRL_IA32E_MODE_GUEST                   __BIT(9)
#define VMCS_VMENTRY_CTRL_ENTRY_TO_SMM                       __BIT(10)
#define VMCS_VMENTRY_CTRL_DEACTIVATE_DUAL_MONITOR_TREATEMENT __BIT(11)
#define VMCS_VMENTRY_CTRL_LOAD_IA32_PERF_GLOBAL_CTRL         __BIT(13)
#define VMCS_VMENTRY_CTRL_LOAD_IA32_PAT                      __BIT(14)
#define VMCS_VMENTRY_CTRL_LOAD_IA32_EFER                     __BIT(15)
#define VMCS_VMENTRY_CTRL_LOAD_IA32_BNDCFGS                  __BIT(16)
#define VMCS_VMENTRY_CTRL_CONCEAL_VMENTRY_FROM_PT            __BIT(17)
